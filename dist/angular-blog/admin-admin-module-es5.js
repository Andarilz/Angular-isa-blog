...
var CreatePageComponent = /** @class */ (function () {
    function CreatePageComponent(postsService, alertService) {
    ...
    CreatePageComponent.prototype.submit = function () {
        ...
        this.postsService.create(post).subscribe(function () {
            _this.form.reset();
            _this.alertService.success('Пост был создан');
        });
    };
...
var DashboardPageComponent = /** @class */ (function () {
    function DashboardPageComponent(postService, alertService) {
    ...
    DashboardPageComponent.prototype.remove = function (id) {
        ...
        this.dSub = this.postService.remove(id).subscribe(function () {
            ...
            _this.alertService.danger('Пост был удален');
        });
    };
...
var EditPageComponent = /** @class */ (function () {
    function EditPageComponent(route, postService, alertService) {
        this.route = route;
        this.postService = postService;
        this.alertService = alertService;
    ...
    EditPageComponent.prototype.submit = function () {
        ...
        this.submitted = true;
        this.uSub = this.postService.update(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.post, { text: this.form.value.text, title: this.form.value.title })).subscribe(function () {
            _this.submitted = false;
            _this.alertService.success('Пост был обновлен');
        });
    };
    ...
    LoginPageComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            if (params['loginAgain']) {
                ...
                _this.message = 'Сессия истекла. Пожалуйста, авторизайтесь';
            }
        });
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
...
var AdminLoadingComponent = /** @class */ (function () {
    function AdminLoadingComponent() {
    }
    AdminLoadingComponent.prototype.ngOnInit = function () {
    };
